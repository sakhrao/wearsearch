...
const LOCKS: Array<[string, number, number, string]> = [
  ...
  ["size medium black tank top", 3, 12, "M+Black via AVAILABLE only, palette-subset Exact"],
  ...
  ["black shoes", 12, 11, "Black shoes via AVAILABLE only, palette-subset Exact"],
  ["brown shoe", 1, 2, "Brown via AVAILABLE only, palette-subset"],
  ["white tank top", 2, 12, "White via AVAILABLE only, palette-subset"],
  ["blue tank top", 3, 12, "Blue via AVAILABLE only, palette-subset"],
  ["green tank top", 4, 6, "Green via AVAILABLE only, palette-subset"],
  ["pink tank top", 4, 7, "Pink via AVAILABLE only, palette-subset"],
  ["blue pants", 0, 35, "Blue Similar via AVAILABLE only, palette-subset"],
  ["black pants", 0, 91, "Black Similar via AVAILABLE only, palette-subset"],
  ["women's black cotton tank top size S", 0, 16, "gender+color+size via AVAILABLE only, palette-subset"],
];
{
