...
check("T blue xyzzy == blue exact (noise tolerated under structured intent) = 35 (palette-subset: mixed-palette blue items demoted to Similar)", blueXyzzyRes.exactCount === blueRes.exactCount && blueXyzzyRes.exactCount === 35, `blue=${blueRes.exactCount} blue xyzzy=${blueXyzzyRes.exactCount}`);
