...
const CASES = [
  ...
  },
  {
    ...
    note: "parent category hierarchy; re-based P1/P4: mislabeled T-Shirt (was Sneakers) is now a Top; PR2-F2 re-based: 37 real Hoodies + 34 real Sweatshirts imported -> Tops subtree 346->417",
  },
  {
    q: "clothing",
    exact: 526,
    ...
    note: "root category hierarchy; re-based P1/P4 (list shifted from Sneakers to T-Shirts; net +1 in Clothing); PR2-F2 re-based: 71 real Hoodies/Sweatshirts joined the Clothing tree -> Clothing 455->526",
  },
  {
    q: "bottoms",
    exact: 109,
  ...
  },
  {
    ...
    similar: 170,
    struct: { color: "Black" },
    note: "new in 6.5.3: unsupported intent gates Exact off (kills pre-spec misleading Exact x4); Similar keeps color-relevant candidates; counts match simulation proxy; PR2-F2 re-based: +17 Black Hoodies/Sweatshirts entered the real catalog -> similar 153->170",
  },
  {
    q: "cargo pants",
    exact: 0,
  ...
  },
  {
    ...
    note: "new in PR2 F2-A: 'sweatpants' aliased to the Joggers category (11 of the 19 real Joggers products carry 'Sweatpants' in the name); was free-text match-all (504)",
  },
  {
  ...
  },
  {
    ...
    note: "new in 6.7.1: sibling list includes empty Shirts too - data first, merchandising later; PR2-F1 re-based: productCount 58->51 (demo tank tops excluded)",
  },
  {
    q: "jeans",
    exact: 1,
