...
const CASES = [
  ...
  },
  {
    ...
    note: "new in 6.5.3: kills 6.5.1 leak where 'black tee' returned Tank Tops as misleading Exact; counts from native-equivalent simulation ('black t shirt')",
  },
  {
    q: "white tee",
    exact: 2,
    ...
    note: "new in 6.5.3: synonym + color refinement; counts from native-equivalent simulation",
  },
  {
    q: "trainer",
    exact: 2,
  ...
  },
  {
    ...
    note: "new in 6.5.3: synonym + color refinement over sneakers; counts from native-equivalent simulation",
  },
  {
    q: "tshirt",
    exact: 3,
  ...
  },
  {
    ...
    similar: 7,
    struct: { category: "T-Shirts", color: "Black" },
    note: "new in 6.5.5: compact spelling + color must equal native 'black t shirt' result shape",
  },
  {
    q: "tanktop",
    exact: 4,
