          ...
          >
            ...
            {filteredExactProducts.length > 0 && (
              <p className="mt-2 text-ink-soft">
                ...
                {filteredExactProducts.length === 1
                  ? "result"
                  : "results"}
              </p>
            )}
            ...
            {loading && filteredExactProducts.length === 0 && (
              <div
                aria-hidden="true"
  ...
  return (
    <article className="group relative flex flex-col overflow-hidden rounded-2xl border border-line bg-surface transition duration-300 hover:-translate-y-0.5 hover:border-accent/30 hover:shadow-xl">
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        {product.gender && (
          <span className="mt-3 inline-block w-fit rounded-full border border-line bg-paper-soft px-3 py-1 text-xs font-medium text-ink-soft">
            {product.gender}
          </span>
        )}
